package KitchenToGridLanguage.org.moflon.tie;
...
public class KitchenToGridLanguageConsistencyCheck extends SynchronizationHelper{

   public KitchenToGridLanguageConsistencyCheck()
   {
      super(KitchenToGridLanguagePackage.eINSTANCE, ".");
   }
	public static void main(String[] args) throws IOException {
		// Set up logging
        BasicConfigurator.configure();
        
        KitchenToGridLanguageConsistencyCheck helper = new KitchenToGridLanguageConsistencyCheck();
