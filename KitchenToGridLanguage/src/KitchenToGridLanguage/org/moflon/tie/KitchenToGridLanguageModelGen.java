...
public class KitchenToGridLanguageModelGen extends SynchronizationHelper{

   public KitchenToGridLanguageModelGen()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		ModelGenerator gen = new ModelGenerator(KitchenToGridLanguagePackage.eINSTANCE, controller);
		gen.generate();
	}
}