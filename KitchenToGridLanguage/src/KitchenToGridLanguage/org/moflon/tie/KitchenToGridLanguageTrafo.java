...
public class KitchenToGridLanguageTrafo extends SynchronizationHelper{

   public KitchenToGridLanguageTrafo()
   {
	...
	public static void main(String[] args) throws IOException {
        ...
        KitchenToGridLanguageTrafo helper = new KitchenToGridLanguageTrafo();
		helper.performForward("instances/fwd.src.xmi");
		
		// Backward Transformation
		helper = new KitchenToGridLanguageTrafo();
