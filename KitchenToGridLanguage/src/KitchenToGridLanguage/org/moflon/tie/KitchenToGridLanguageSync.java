...
public class KitchenToGridLanguageSync extends SynchronizationHelper{

   public KitchenToGridLanguageSync()
   {
	...
	public static void main(String[] args) throws IOException {
		...
		KitchenToGridLanguageSync helper = new KitchenToGridLanguageSync();
